...
export function ProjectIdeaCard() {
  return (
    <CardContainer className="inter-var !py-0">
      <CardBody
        className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-2 border">
...
export function MacbookScrollDemo({ containerRef }) {
  return (
      ...
      <div className="flex justify-center items-center mt-20 z-10 relative">
        <motion.div 
          ...
          <LayoutTextFlip 
            ...
            className="text-4xl md:text-6xl gap-3 text-white"
