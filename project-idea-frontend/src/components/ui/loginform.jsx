...
export function LoginForm({
  ...
  const introContent = (triggerExit) => (
    <div className="flex flex-col items-center justify-center ">
      <div
        className="mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white dark:text-black text-center">
        Project Vision
      </div>
      <div
        className="text-lg sm:text-xl md:text-2xl text-white dark:text-black font-light tracking-wide opacity-80 max-w-[280px] sm:max-w-md text-center break-words">
                ...
                <div className="p-6 md:p-8 relative">
                  <div className="flex flex-col gap-6 relative z-10">
                    <div className="flex flex-col items-center text-center">
                      <h1
                        className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 bg-clip-text text-transparent">
                        Welcome back
                      </h1>
                    ...
                    <div className="grid gap-4">
                      <div className="space-y-2">
                        <Label
                          htmlFor="email"
                          className="text-sm dark:text-black text-white font-medium">Email</Label>
                        <Input
                          id="email"
                          type="email"
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <Label
                            htmlFor="password"
                            className="text-sm dark:text-black text-white  font-medium">Password</Label>
                          <a
                            href="#"
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-xs uppercase">
                        <span
                          className="bg-white dark:bg-black dark:text-gray-200 px-3 text-gray-500 font-medium">
                          Or continue with
                        </span>
                      </div>
                    </div>
